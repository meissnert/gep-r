...
CD-138 purity (flow cytometry)\footnote{Test}: & \Sexpr{svalue(probe.purity.facs)} \% \tabularnewline
CD-138 purity (iFISH)\footnote{Test}: & \Sexpr{svalue(probe.purity.fish)} \% \tabularnewline
