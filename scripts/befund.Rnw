...
Zhan Molecular Class. (Zahn et al, 2006) & \Sexpr{shmol} & [PR, LB, MS, HY, CD1, CD2, MF] \tabularnewline \hline
\end{tabular}
...
Zs-Score (Reme et al., 2010) & \Sexpr{Zs} & [high, medium, low] \tabularnewline \hline
\end{tabular}
