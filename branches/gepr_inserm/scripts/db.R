...
createDBTable(con, 
	      ...
	      attributes=c("CEL", "NAME", "FIRST_NAME", "BIRTH", "STREET", "CITY", "ZIPCODE", 
			   ...
			   "SAMPLE_DATE", "SAMPLE_VOLUME", "CD_138_PURIFICATION", "ARRAY_TYPE", "RNA_PURIFICATION_PROTOCOLL", "NORMALIZATION_METHOD",
			   ...
			   "REPORT"), 
	      data.types=c("VARCHAR(100)", "VARCHAR(30)", "VARCHAR(30)", "DATE", "VARCHAR(30)", "VARCHAR(30)", "REAL",
			   "VARCHAR(30)", "VARCHAR(30)", "VARCHAR(30)", "VARCHAR(30)",
			   "DATE", "REAL", "VARCHAR(30)", "VARCHAR(30)", "VARCHAR(30)",
